      ...
      <div className="bg-card/95 backdrop-blur-sm border-2 border-primary/20 rounded-[2rem] px-6 py-3 shadow-lg">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-primary tracking-wide">Opération Atlas</h1>
          </div>

          {timeRemaining !== undefined && (
            <div className="flex items-center gap-4">
              {currentStep && <span className="text-sm text-muted-foreground font-medium">{currentStep}</span>}
